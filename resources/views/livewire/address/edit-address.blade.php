@section('title', @ucfirst(__('address.edit_that', ['what' => $address->place_name])))

<div>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-slate-800 dark:text-slate-100 leading-tight">
            <span class="inline-flex align-middle">
                @ucfirst(__('address.edit_that', ['what' => $address->place_name]))
            </span>
        </h2>
    </x-slot>
    ...
    <script>
        document.addEventListener('livewire:load', function () {
            ...
            L.Control.geocoder({
                ...
                @this.$set('address_number', e.geocode.properties.address.house_number);
