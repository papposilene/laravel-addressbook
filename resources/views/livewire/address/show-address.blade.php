            ...
            <div class="flex flex-col pl-2 pr-2 w-3/4">
                ...
                <div class="bg-slate-200 p-3 text-xl rounded-b">
                    ...
                    <div class="flex flex-col w-full">
                        <span class="pt-2 px-2 text-right">
                            <a href="{{ route('front.category.index', ['filter' => $address->belongsToSubcategory->belongsToCategory->slug]) }}">
                                <span class="inline-flex align-middle">
                                    ...
                                    <svg class="{{ $address->belongsToSubcategory->belongsToCategory->icon_style }} h-5 w-5">
                        ...
                        <span class="pb-2 px-2 text-right">
                    ...
                    <div class="flex flex-row py-3">
                        <span class="bg-slate-300 text-black py-2 px-4 inline-flex items-center">
